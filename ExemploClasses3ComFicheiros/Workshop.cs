...
namespace ExemploClasses3ComFicheiros
{
    ...
    public class Workshop
    {
        ...
        public void readFromFile()
        {
            ...
            Stream stream = new FileStream("workshopCars.txt", FileMode.Open, FileAccess.Read);
            this.cars = (Car[])formatter.Deserialize(stream);
            stream.Close();
        }
        ...
        {
            IFormatter formatter = new BinaryFormatter();
            Stream stream = new FileStream("workshopCars.txt", FileMode.Create, FileAccess.Write);
